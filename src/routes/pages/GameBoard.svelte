<script>
    ...
    function draw() {
        ...
        let coord_indent = [parseInt(game.coord_mode[4]), parseInt(game.coord_mode[5]), parseInt(game.coord_mode[6]), parseInt(game.coord_mode[7])];
        ...
        if (have_coord[1]) {
            ...
            for (let i = coord_indent[2] + indent; i < cols_len - coord_indent[3] + indent; i++) {
                ctx.fillText(getText(i, cols_len, game.coord_mode[1]), i * finalWidth +  Math.round(finalWidth / 2),  Math.round(finalWidth / 2));
            }
            row_count += 1;
        }
        if (have_coord[3]) {
            ...
            for (let i = coord_indent[2] + indent; i < cols_len - coord_indent[3] + indent; i++) {
                ctx.fillText(getText(i, cols_len, game.coord_mode[1]), i * finalWidth +  Math.round(finalWidth / 2),  (row_count + rows_len) * finalWidth + Math.round(finalWidth / 2));
            }
        }
        //绘制纵向
        let col_count = 0; //计数
        if (have_coord[0]) {
            ...
            for (let i = coord_indent[0] + indent; i < rows_len - coord_indent[1] + indent; i++) {
                ctx.fillText(getText(i, rows_len, game.coord_mode[0]),  Math.round(finalWidth / 2), i * finalWidth +  Math.round(finalWidth / 2));
            }
            col_count += 1;
        }
        if (have_coord[2]) {
            ...
            for (let i = coord_indent[2] + indent; i < rows_len - coord_indent[3] + indent; i++) {
        ...
        for (let i = 0; i < rows_len + 1; i++) {
            ...
            ctx.lineTo(board_x + cols_len * finalWidth, board_y + i * finalWidth);
        }
        //纵向
        for (let i = 0; i < cols_len + 1; i++) {
            ctx.moveTo(board_x + i * finalWidth, board_y);
            ctx.lineTo(board_x + i * finalWidth, board_y + rows_len * finalWidth);
        }
        ctx.stroke();
        ...
        for(let i = 0; i < game_board.cols_len; i++) {
            for(let j = 0; j < game_board.rows_len; j++) {
                ...
                if(piece_mode === 1) {
                    ctx.beginPath();
                    ctx.fillStyle = "black";
                    ctx.arc(board_x + j* finalWidth + finalWidth / 2, board_y + i * finalWidth + finalWidth / 2, finalWidth / 2 * 0.85, 0, 2 * Math.PI);
                    ctx.fill();
                    ...
                    ctx.arc(0, -radius * 0.5, radius * 0.5, Math.PI * 1.5, Math.PI * 0.5, true);
                    ctx.arc(0, radius * 0.5, radius * 0.5, Math.PI * 1.5, Math.PI * 0.5, false);
                    ctx.closePath();
                    ctx.fillStyle = 'black';
                    ctx.fill();
                    ...
                    ctx.fillRect(board_x + j* finalWidth , board_y + i * finalWidth, finalWidth, finalWidth );

                    
                    ctx.beginPath();
                    ctx.fillStyle = "red";
                    ctx.fillRect(board_x + j* finalWidth , board_y + i * finalWidth , finalWidth * 0.65 , finalWidth * 0.25 );
                    ctx.strokeStyle = 'black';
                    ctx.lineWidth = 2;
                    ctx.strokeRect(board_x + j* finalWidth , board_y + i * finalWidth  , finalWidth * 0.65 , finalWidth * 0.25 );

                    ctx.beginPath();
                    ctx.fillStyle = "red";
                    ctx.fillRect(board_x + j* finalWidth + finalWidth * 0.35, board_y + i * finalWidth + finalWidth * 0.25, finalWidth * 0.65, finalWidth * 0.25);
                    ctx.strokeStyle = 'black';
                    ctx.lineWidth = 2;
                    ctx.strokeRect(board_x + j* finalWidth + finalWidth * 0.35, board_y + i * finalWidth + finalWidth * 0.25, finalWidth * 0.65, finalWidth * 0.25);

                    ctx.beginPath();
                    ctx.fillStyle = "red";
                    ctx.fillRect(board_x + j* finalWidth , board_y + i * finalWidth + finalWidth * 0.5 , finalWidth * 0.65 , finalWidth * 0.25 );
                    ctx.strokeStyle = 'black';
                    ctx.lineWidth = 2;
                    ctx.strokeRect(board_x + j* finalWidth , board_y + i * finalWidth + finalWidth * 0.5 , finalWidth * 0.65 , finalWidth * 0.25 );

                    ctx.beginPath();
                    ctx.fillStyle = "red";
                    ctx.fillRect(board_x + j* finalWidth + finalWidth * 0.35, board_y + i * finalWidth + finalWidth * 0.75, finalWidth * 0.65, finalWidth * 0.25);
                    ctx.strokeStyle = 'black';
                    ctx.lineWidth = 2;
                    ctx.strokeRect(board_x + j* finalWidth + finalWidth * 0.35, board_y + i * finalWidth + finalWidth * 0.75, finalWidth * 0.65, finalWidth * 0.25);

                  

                    ctx.strokeStyle = 'black';
                    ctx.lineWidth = 4;
                    ctx.strokeRect(board_x + j* finalWidth, board_y + i * finalWidth, finalWidth, finalWidth);
                     ctx.restore();
                }else if(piece_mode === 11) {
                    ctx.beginPath();
                    ctx.fillStyle = "black";
                    ctx.fillRect(board_x + j* finalWidth + finalWidth / 2 - finalWidth  * 0.8 * 0.5, board_y + i * finalWidth + finalWidth / 2 - finalWidth  * 0.8 * 0.5, finalWidth  * 0.8, finalWidth  * 0.8);
                    ...
                    ctx.strokeStyle = 'black';
                    ctx.lineWidth = 2;
                    ctx.strokeRect(board_x + j* finalWidth + finalWidth / 2 - finalWidth  * 0.8 * 0.5, board_y + i * finalWidth + finalWidth / 2 - finalWidth  * 0.8 * 0.5, finalWidth  * 0.8, finalWidth  * 0.8);
